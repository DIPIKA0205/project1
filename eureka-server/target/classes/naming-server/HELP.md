...
* The original package name 'com.cg.eShoppingZone.namingserver.naming-server' is invalid and this project uses 'com.cg.eShoppingZone.namingserver.namingserver' instead.
